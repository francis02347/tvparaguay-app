...
public class RecommendedChannels {
    ...
    public static final List<String> ORDERED_NAMES = Arrays.asList(
        ...
        "Tooncast (Latinoamérica)",
        "BabyFirst TV (Español)",
        "Clan TVE (España - 1080p)",
        "El Reino Infantil (Canciones Infantiles)",
        "Bob Esponja (24/7)",
        "Avatar: La Leyenda de Aang (24/7)",
        "Nick Clásico (Latinoamérica)",
        "Nick Jr. Club (Latinoamérica)",
        "Nickelodeon Toons (Latinoamérica)",
        "Rugrats (24/7)",
        "Pluto TV Junior (Latinoamérica)",
        "Pluto TV Kids (Latinoamérica)",
